...
\begin{document}
	...
	\begin{tcolorbox}[colback=gray!0!white,colframe=gray!3!white, boxed title style={empty, size=minimal, bottom=1.5mm}]
...
\section{Appendix} \label{Misc}

\begin{tcolorbox}[enhanced,fit to height=3cm,
	colback=gray!2!black!3!white,colframe=green!10!black,title=\textbf{Environmental Benefits},
	drop fuzzy shadow]
